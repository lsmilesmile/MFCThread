...
CMultiThread1Dlg::CMultiThread1Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MULTITHREAD1_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CMultiThread1Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_START, &CMultiThread1Dlg::OnBnClickedStart)
	ON_BN_CLICKED(IDC_STOP, &CMultiThread1Dlg::OnBnClickedStop)
END_MESSAGE_MAP()
